...
@app.route('/goods_potential/', endpoint='goods_potential')
@visitor_record
def goods_potential():
    """潜在货源统计页面"""
    ...
    return render_template('/goods_potential/goods_potential_statistics.html', user_name=user_name, avatar_url=avatar_url, locations=locations, role=role, account=account)
