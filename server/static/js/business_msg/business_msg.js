                ...
                , cols: [[
                    ...
                    $('.defail-operate').click(function () {
                        ...
                        layer.open({
                            ...
                            '\n <div class="bottom"><button onclick="fail_('+msg_id+')" class="layui-btn layui-btn-normal defail_btn">确认</button> ' +
...
function fail_(msg_id) {
    var url = '/business_msg/business_msg/' + msg_id;
    var follow_result = $("#defail_result").text()
    var data = {
        follow_name: "",
