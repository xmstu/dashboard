/*
* 这个是所有项目中最恶心的一个，根据用户的点击获取当前区域的id
* 然后将这个id传送给后台，后台获取id后返回的不是当前区域的数据而是下一级的数据
* 当用户点击的是第三级的时候，自动返回全国，
* 管理员看到的是全国，城市经理看到的是当前管理区域，所以这个页面有两个方法一个是为了管理员一个是为了城市经理。
*/
var provinces = {
    "台湾": "taiwan",
    "河北": "130000",
...
var set = {
    ...
    dataInit: function () {
        ...
        layui.use(['form', 'layer'], function () {
            ...
            /*根据监听method_select下拉框显示不同的下拉框，来实现模拟联动的效果*/
