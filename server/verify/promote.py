...
class PromoteEffect(object):
    ...
    def check_params(page, limit, params):
        ...
        try:
            ...
            start_time = int(params.get('start_time')) if params.get('start_time') else 1356969600
            end_time = int(params.get('end_time')) if params.get('end_time') else time.time() - 86400
